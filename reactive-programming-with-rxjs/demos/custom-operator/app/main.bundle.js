...
/***/ function(module, exports, __webpack_require__) {
	...
	function multiplyBy(multiplier) {
	    ...
	    var result = Rx.Observable.create(function subscribe(observer) {
	        source.subscribe(function (value) { return observer.next(value * multiplier); }, function (err) { return observer.error(err); }, function () { return observer.complete(); });
	    });
	    return result;
	}
	Rx.Observable.prototype.multiplyBy = multiplyBy;
	var numbers = Rx.Observable.of(1, 2, 3, 4, 5)
	    .multiplyBy(10);
	numbers.subscribe(function (value) { return console.log(value); }, function (error) { return console.error(error); }, function () { return console.log('Done!'); });
